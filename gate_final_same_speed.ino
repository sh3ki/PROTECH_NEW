...
void performGateCycle() {
  ...
  // CLOCKWISE - 1.5 seconds (opens gate)
  Serial.println("→ Rotating CLOCKWISE (1500ms)");
  digitalWrite(GREEN_LED, LOW);
  digitalWrite(RED_LED, HIGH);
  ...
  // COUNTER-CLOCKWISE - 1.5 seconds (closes gate - same rotation)
  Serial.println("→ Rotating COUNTER-CLOCKWISE (1500ms)");
  ...
  Serial.println("NOTE: Speed controlled by manual knob on motor driver");
  Serial.println("Adjust knob to desired gate speed\n");
