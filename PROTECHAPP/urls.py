...
# ==========================
    ...
    path('admin/calendar/events/', admin_views.get_calendar_events, name='get_calendar_events'),
    path('admin/calendar/add-event/', admin_views.add_calendar_event, name='add_calendar_event'),
    path('admin/calendar/add-announcement/', admin_views.add_calendar_announcement, name='add_calendar_announcement'),
    path('admin/calendar/delete-event/<int:event_id>/', admin_views.delete_calendar_event, name='delete_calendar_event'),
    ...
    path('admin/settings/save-holiday-mode/', admin_views.save_holiday_mode, name='save_holiday_mode'),
...
# ==========================   
    ...
    path('registrar/calendar/', registrar_views.registrar_calendar, name='registrar_calendar'),
    path('registrar/calendar/events/', registrar_views.get_registrar_calendar_events, name='get_registrar_calendar_events'),
